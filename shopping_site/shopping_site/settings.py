...
TEMPLATES_DIR='c:\\Users\\hp\\OneDrive\\Desktop\\Dj-A2\\scripts\\Scripts\\shopping_site\\templates'

# Quick-start development settings - unsuitable for production
# See https://docs.djangoproject.com/en/5.1/howto/deployment/checklist/

# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = 'django-insecure-^c-ze35w&^$6f&nu3j%hc679=(hi)jbf7ub6*4dk4u)=_1vwhq'
...
MEDIA_URL = '/media/'  # URL path for accessing media files (images, etc.)
